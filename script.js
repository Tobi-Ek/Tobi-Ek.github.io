...
var arr = [
    { "Name": "Data Farmland [2024]", "Link": "https://github.com/Tobi-Ek/Deep-Farmland", 'Description': 'Data Farmland is a solution designed to offer a comprehensive view of enterprise data architecture and metadata, streamlining the data lifecycle management process for businesses. It is developed to enable businesses efficiently manage their data lifecycle by providing valuable insights into data architecture and metadata', 'Tech': 'Python | PowerBI | Tableau | MS Excel | Wix | MongoDB | PostgreSQL'},

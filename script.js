...
var typed = new Typed('.element', {
    ...
    strings: ['Data Analysis.', 'Data Engineering.', 'Business Intelligence.', 'Data Visualization.', 'Machine Learning.', 'Deep Learning.', 'ML Applications.', 'Project Management.'],
    typeSpeed: 100,
    loop: true,
    loopCount: Infinity,
  });
...
var arr = [
    { "Name": "Data Farmland [2025]", "Link": "https://github.com/Tobi-Ek/Deep-Farmland", 'Description': 'Data Farmland is a solution designed to offer a comprehensive view of enterprise data architecture and metadata, streamlining the data lifecycle management process for businesses. It is developed to enable businesses efficiently manage their data lifecycle by providing valuable insights into data architecture and metadata', 'Tech': 'Python | PowerBI | Tableau | MS Excel | Wix | MongoDB | PostGre SQL'},
    { "Name": "RecycliQ [2021]", "Link": "https://github.com/Tobi-Ek/RecycliQ-Deep-Learning", 'Description': 'Developed a gamified recycling android mobile app (RecycliQ) that implemented an on-device deep learning framework to encourage the recycling of waste. The mobile app classifies scanned waste images into one of seven waste categories namely: e-waste, garbage, glass, metal, organic, paper, plastic.', 'Tech': 'Python | TensorFlow | Keras | TensorFlow Lite | Google Colab | Flutter | Dart | Adobe XD | VS Code'},
    { "Name": "Predictive Analysis of Retail Sales: Furniture and Home Furnishings [2020]", "Link": "https://github.com/Tobi-Ek/Predictive-Analysis-of-Retail-Sales-_-Furniture-and-Home-Furnishings", 'Description': 'Provided valuable data insights for strategic planning on furniture and home furnishings products by carrying out exploratory data analysis using Excel and PowerBI. Finally provided predictive analysis using Holt-Winters model with R programming language in well documented reports.', 'Tech': 'PowerBI | R | RStudio | Timeseries Forecast'},
    { "Name": "Application of Database Systems and Analytics to Covid19 Disease [2020]", "Link": "https://github.com/Tobi-Ek/Application-of-Database-Systems-and-Analytics-to-Covid19-Disease", 'Description': 'Used python for web-scrapping data off websites, extracted XML data, stored these data into mongoDB, cleaned and saved the processed data into PostgreSQL and created data visualizations showing the global impact of COVID-19.', 'Tech': 'Python | Webscrapping | MongoDB | PostgreSQL | Pandas | MathLib | MS Excel'},
    { "Name": "Evaluation of Machine Learning Algorithms [2020]", "Link": "https://github.com/Tobi-Ek/Evaluation-of-Machine-Learning-Algorithms", 'Description': 'Evaluated five (5) different machine learning models using R programming language on housing price, bank loan and crimes data.', 'Tech': 'R | R Studio'},
    { "Name": "London Underground High-Speed Line Simulation and Optimization [2020]", "Link": "https://github.com/Tobi-Ek/Simulation-and-Optimisation-of-HS2-Train-Line-From-London-to-Birmingham", 'Description': 'The project involved discrete event simulation and optimization. The project modelled, simulated and optimized the London Old Oak Commons to Birmingham Interchange section of the London Underground high-speed line.', 'Tech': 'Python | SimPy | Pandas | Numpy'},
    { "Name": "GreenFinder Deep Learning [2020]", "Link": "https://github.com/Tobi-Ek/GreenFinder-Deep-Learning", 'Description': 'Developed an android mobile app (GreenFinder), trained, and evaluated two deep learning image classification models for the use-case. The mobile app classifies scanned fruits, vegetables and flowers, as well as provides knowledgeable information on each classified item.', 'Tech': 'Python | TensorFlow | Keras | TensorFlow Lite | Knowledge Graph | MS Excel | Android Studio'},
  ];

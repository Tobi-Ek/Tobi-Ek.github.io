...
var arr = [
    { "Name": "Data Farmland [2025]", "Link": "https://github.com/Tobi-Ek/Deep-Farmland", 'Description': 'Data Farmland is a solution designed to offer a comprehensive view of enterprise data architecture and metadata, streamlining the data lifecycle management process for businesses.', 'Tech': 'Python | PowerBI | Tableau | Excel | Wix | '},
	{ "Name": "RecycliQ (A gamified recycling mobile app) [2021]", "Link": "https://github.com/Tobi-Ek/RecycliQ-Deep-Learning", 'Description': 'Developed an android mobile app (RecycliQ) that implemented an on-device deep learning framework to encourage the recycling of waste. The mobile app classifies scanned waste images into one of seven waste categories namely: e-waste, garbage, glass, metal, organic, paper, plastic.', 'Tech': 'Python | TensorFlow | Keras | TensorFlow Lite | Google Colab | Flutter | Dart | Adobe XD | VS Code'},
